...
export function ChatForm({ className, ...props }: React.ComponentProps<"form">) {
  ...
  const header = (
    <header className="m-auto flex max-w-96 flex-col gap-5 text-center">
      <h1 className="text-2xl font-semibold leading-none tracking-tight">ChatBot - Assistente, Furioso!</h1>
      <p className="text-muted-foreground text-sm">
        Seu assitente para dúvidas sobre o time de CS2 da Furia <span className="text-foreground">Next.js</span>, the{" "}
